...
public class ZGallery5Activity extends Activity {
	...
	public class AC implements OnClickListener{
		...
		public void onClick(View v) {
			...
			Intent i=new Intent();
			i.setClass(ZGallery5Activity.this,ChoseActivity.class);
			startActivity(i);
		}
}
        ...
        public boolean onTouch(View v, MotionEvent event) { 
            ...
            case MotionEvent.ACTION_MOVE: 
                ...
                if(lastX>=220&&lastY<=656&&lastY>=456){
                	...
                	mediaplay=MediaPlayer.create(ZGallery5Activity.this, R.raw.happy);
                	mediaplay.start();
                	sum=sum+1;
                	if(sum>=6){
                		Intent i=new Intent();

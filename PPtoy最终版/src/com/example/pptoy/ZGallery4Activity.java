...
public class ZGallery4Activity extends Activity {
	...
	public class ABCA implements OnClickListener{
		...
		public void onClick(View v) {
			...
			Intent i=new Intent();
			i.setClass(ZGallery4Activity.this,ChoseActivity.class);
			startActivity(i);
		}
}
        ...
        public boolean onTouch(View v, MotionEvent event) { 
            ...
            case MotionEvent.ACTION_MOVE: 
                ...
                if(lastX>=337&&lastY>=567){
                	...
                	mediaplay=MediaPlayer.create(ZGallery4Activity.this, R.raw.happy);
                	mediaplay.start();
                	AQ=true;
                	if(AQ==true&&BQ==true){
                		Intent i=new Intent();
         				i.setClass(ZGallery4Activity.this,ZGallery5Activity.class);
         				startActivity(i);	
                	}
                	}
                break; 

...
public class SGallery5Activity extends Activity {
	...
	public class AC implements OnClickListener{
		...
		public void onClick(View v) {
			...
			Intent i=new Intent();
			i.setClass(SGallery5Activity.this,ChoseActivity.class);
			startActivity(i);
		}
}
        ...
        public boolean onTouch(View v, MotionEvent event) { 
            ...
            case MotionEvent.ACTION_MOVE: 
                ...
                if(lastX>=220&&lastY<=656&&lastY>=456){
                	...
                	mediaplay=MediaPlayer.create(SGallery5Activity.this, R.raw.happy);
                	mediaplay.start();
                	AQ=true;

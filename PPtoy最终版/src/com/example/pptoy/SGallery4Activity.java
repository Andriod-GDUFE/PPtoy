...
public class SGallery4Activity extends Activity {
	...
	public class ABCA implements OnClickListener{
		...
		public void onClick(View v) {
			...
			Intent i=new Intent();
			i.setClass(SGallery4Activity.this,ChoseActivity.class);
			startActivity(i);
		}
}
        ...
        public boolean onTouch(View v, MotionEvent event) { 
            ...
            case MotionEvent.ACTION_MOVE: 
                ...
                if(lastX>=337&&lastY>=567){
                	...
                	mediaplay=MediaPlayer.create(SGallery4Activity.this, R.raw.happy);
                	mediaplay.start();
                	AQ=true;
                	if(AQ==true&&BQ==true){
                		Intent i=new Intent();
         				i.setClass(SGallery4Activity.this,SGallery5Activity.class);
         				startActivity(i);	
                	}
                	}
                break; 

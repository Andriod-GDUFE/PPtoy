...
public class DGallery3Activity extends Activity {
	...
	public class ABC implements OnClickListener{
		...
		public void onClick(View v) {
			...
			Intent i=new Intent();
			i.setClass(DGallery3Activity.this,ChoseActivity.class);
			startActivity(i);
		}
}
        ...
        public boolean onTouch(View v, MotionEvent event) { 
            ...
            case MotionEvent.ACTION_MOVE: 
                ...
                if(lastX<=126&&lastY>=644){
                	...
                	mediaplay=MediaPlayer.create(DGallery3Activity.this, R.raw.happy);
                	mediaplay.start();
                	AQ=true;
                	if(AQ==true&&BQ==true&&CQ==true){
            			Intent i=new Intent();
            			i.setClass(DGallery3Activity.this,DGallery4Activity.class);
            			startActivity(i);

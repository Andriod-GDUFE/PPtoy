...
public class DGallery1Activity extends Activity {
	...
	public class ABC implements OnClickListener{
		...
		public void onClick(View v) {
			...
			Intent i=new Intent();
			i.setClass(DGallery1Activity.this,ChoseActivity.class);
			startActivity(i);
		}
}
        ...
        public boolean onTouch(View v, MotionEvent event) { 
            ...
            case MotionEvent.ACTION_MOVE: 
                ...
                if(lastX<=367&&lastY<=367){
                	...
                	mediaplay=MediaPlayer.create(DGallery1Activity.this, R.raw.happy);
                	mediaplay.start();
                	Intent i=new Intent();
     				i.setClass(DGallery1Activity.this,DGallery2Activity.class);
     				startActivity(i);
                	}
                break; 

...
public class SGallery1Activity extends Activity {
	...
	public class ABC implements OnClickListener{
		...
		public void onClick(View v) {
			...
			Intent i=new Intent();
			i.setClass(SGallery1Activity.this,ChoseActivity.class);
			startActivity(i);
		}
}
        ...
        public boolean onTouch(View v, MotionEvent event) { 
            ...
            case MotionEvent.ACTION_MOVE: 
                ...
                if(lastX<=367&&lastY<=367){
                	...
                	mediaplay=MediaPlayer.create(SGallery1Activity.this, R.raw.happy);
                	mediaplay.start();
                	Intent i=new Intent();
     				i.setClass(SGallery1Activity.this,SGallery2Activity.class);
     				startActivity(i);
                	}
                break; 
